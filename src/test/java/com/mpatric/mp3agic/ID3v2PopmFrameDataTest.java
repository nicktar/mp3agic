...
class ID3v2PopmFrameDataTest {
	...
	void shouldReturnAddress() throws Exception {
		...
		assertThat(iD3v2PopmFrameData.getAddress()).isEqualTo("Address");
	}

	@Test
	void shouldReturn1StarRating() throws Exception {
		byte[] bytes = {'A', 'd', 'd', 'r', 'e', 's', 's', 0, (byte) 0x01};
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, bytes);
		assertThat(iD3v2PopmFrameData.getRating()).isEqualTo(1);
	}

	@Test
	void shouldReturn2StarRating() throws Exception {
		byte[] bytes = {'A', 'd', 'd', 'r', 'e', 's', 's', 0, (byte) 0x40};
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, bytes);
		assertThat(iD3v2PopmFrameData.getRating()).isEqualTo(2);
	}

	@Test
	void shouldReturn3StarRating() throws Exception {
		byte[] bytes = {'A', 'd', 'd', 'r', 'e', 's', 's', 0, (byte) 0x80};
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, bytes);
		assertThat(iD3v2PopmFrameData.getRating()).isEqualTo(3);
	}

	@Test
	void shouldReturn4StarRating() throws Exception {
		byte[] bytes = {'A', 'd', 'd', 'r', 'e', 's', 's', 0, (byte) 0xC4};
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, bytes);
		assertThat(iD3v2PopmFrameData.getRating()).isEqualTo(4);
	}

	@Test
	void shouldReturn5StarRating() throws Exception {
		byte[] bytes = {'A', 'd', 'd', 'r', 'e', 's', 's', 0, (byte) 0xFF};
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, bytes);
		assertThat(iD3v2PopmFrameData.getRating()).isEqualTo(5);
	}

	@Test
	void shouldReturnMinus1ForInvalidRating() throws Exception {
	...
	@Test
	void canSetAndGetRating() throws Exception {
		byte[] bytes = {0};
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, bytes);
	...
	@Test
	void canSetAndGetAddress() throws Exception {
		byte[] bytes = {0};
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, bytes);
		iD3v2PopmFrameData.setAddress("New Address");
		assertThat(iD3v2PopmFrameData.getAddress()).isEqualTo("New Address");
	}

	@Test
	void canGetLength() throws Exception {
		...
		assertThat(iD3v2PopmFrameData.getLength()).isEqualTo(expectedLength);
	}

	@Test
	void canPackFrameData() throws Exception {
		...
		for (byte expectedByte : expectedBytes) {
			assertThat(result[i++]).isEqualTo(expectedByte);
		}
	}

	@Test
	void hashCodeOfTwoDifferentObjectsAreDifferent() throws Exception {
	...
	@Test
	void twoEquivalentObjectsAreEquals() throws Exception {
		ID3v2PopmFrameData iD3v2PopmFrameData1 = new ID3v2PopmFrameData(false, 0);
		ID3v2PopmFrameData iD3v2PopmFrameData2 = new ID3v2PopmFrameData(false, 0);
		assertThat(iD3v2PopmFrameData2).isEqualTo(iD3v2PopmFrameData1);
	}

	@Test
	void sameObjectsAreEquals() throws Exception {
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, 0);
		assertThat(iD3v2PopmFrameData).isEqualTo(iD3v2PopmFrameData);
	}

	@Test
	void ID3v2PopmFrameDataIsNotEqualOtherType() throws Exception {
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, 0);
		assertFalse(iD3v2PopmFrameData.equals("a String"));
	}

	@Test
	void ID3v2PopmFrameDataIsNotEqualNull() throws Exception {
		ID3v2PopmFrameData iD3v2PopmFrameData = new ID3v2PopmFrameData(false, 0);
		assertFalse(iD3v2PopmFrameData.equals(null));
	}

	@Test
	void ID3v2PopmFrameDataIsNotEqualOtherWithDifferentRating() throws Exception {
	...
	@Test
	void ID3v2PopmFrameDataIsNotEqualOtherWithDifferentAddress() throws Exception {
		ID3v2PopmFrameData iD3v2PopmFrameData1 = new ID3v2PopmFrameData(false, 1);
	...
	@Test
	void ID3v2PopmFrameDataIsNotEqualOtherWithNullAddress() throws Exception {
		ID3v2PopmFrameData iD3v2PopmFrameData1 = new ID3v2PopmFrameData(false, 1);
		iD3v2PopmFrameData1.setAddress("Address1");
		ID3v2PopmFrameData iD3v2PopmFrameData2 = new ID3v2PopmFrameData(false, 1);
