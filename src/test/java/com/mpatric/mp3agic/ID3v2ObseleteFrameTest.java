...
class ID3v2ObseleteFrameTest {
	...
	@Test
	void shouldReadValidLong32ObseleteTFrame() throws Exception {
		...
		assertThat(frame.getLength()).isEqualTo(263);
		assertThat(frame.getId()).isEqualTo("TP1");
	...
	@Test
	void shouldReadValid32ObseleteTFrame() throws Exception {
		...
		assertThat(frame.getLength()).isEqualTo(40);
		assertThat(frame.getId()).isEqualTo("TP1");
